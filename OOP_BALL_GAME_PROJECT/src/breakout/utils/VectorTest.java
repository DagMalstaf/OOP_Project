...
class VectorTest {
	...
	@Test
	void testVector() {
		assertEquals(Vector.magnetSpeed(new Point(3,4), new Point(0,0), 1, V34),v34);
		assertEquals(Vector.magnetSpeed(new Point(4,5), new Point(0,0), 1, V34),new Vector(-4,-4));
		assertEquals(Vector.magnetSpeed(new Point(4,5), new Point(0,0), -1, V34),new Vector(4,4));
		assertEquals(Vector.magnetSpeed(new Point(4,5), new Point(0,0), 2, V34),new Vector(-4,-5));
		assertEquals(Vector.magnetSpeed(new Point(10,15), new Point(0,0), 3, V34),new Vector(-4,-6));
		assertEquals(Vector.magnetSpeed(new Point(10,15), new Point(0,0), 4, V34),new Vector(-5,-7));
		assertEquals(Vector.magnetSpeed(new Point(10,15), new Point(0,0), 5, V34),new Vector(-5,-7));
		assertEquals(v00.floorCeil(5.0),5);
		assertEquals(v00.floorCeil(-5.0),-5);
		assertEquals(v00.floatScale(5.0),v00);
		assertEquals(v34.floatScale(1.0),v34);
		assertEquals(v34.floatScale(2.0), new Vector(6,8));
		assertEquals(v00.getLength(),0);
	...
	void testEqualsObject() {
		assertNotEquals(v34, new Point(3,4));
		assertNotEquals(v34, new Vector(3,5));
